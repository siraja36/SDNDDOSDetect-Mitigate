...
class SimpleMonitor13(switchm.SimpleSwitch13):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.flow_model = keras.models.load_model('cnn.h5')
    ...
    def flow_predict(self):
        try:
            ...
            # Reshape X_predict_flow to match the input shape of the CNN model
            X_predict_flow = np.expand_dims(X_predict_flow, axis=-1)
            
            # Use the loaded CNN model to predict traffic
